...
for (const script of ['browser-smoke', 'source-check', 'recorder-check', 'selection-check', 'spectrogram-check', 'processing-check', 'preview-check', 'export-check', 'layout-check', 'edge-cases']) {
